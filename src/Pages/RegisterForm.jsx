...
export default function RegisterForm() {
  ...
  return (
    <form
      ...
      className="
        max-w-md w-full mx-auto p-6 bg-white shadow-2xl shadow-rose-900 rounded-xl space-y-6 mt-16
        sm:max-w-lg sm:p-8
        md:max-w-xl
        lg:max-w-lg
        xl:max-w-md
    ...
    >
      <div>
        <label htmlFor="userName" className="block text-rose-900 font-semibold">
          UserName :
        </label>
        <input
          type="text"
      ...
      <div>
        <label
          ...
          className="block text-rose-900 font-semibold"
        >
          Confirm Password :
        </label>
        <input
      ...
      <p className="text-center text-[13.1px] text-gray-800">
        ...
        <Link to="/login" className="text-rose-900 hover:underline">
          Login
        </Link>
      </p>
